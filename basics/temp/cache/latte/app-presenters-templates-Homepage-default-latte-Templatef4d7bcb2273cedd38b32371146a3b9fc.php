<?php
// source: /Users/wise/Sites/atoto-work/app/presenters/templates/Homepage/default.latte

class Templatef4d7bcb2273cedd38b32371146a3b9fc extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('82c9ac2ed9', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb7a4df9e7ee_content')) { function _lb7a4df9e7ee_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbfe5fc20959_title')) { function _lbfe5fc20959_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb1deb612e83_scripts')) { function _lb1deb612e83_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb4fa799270c_head')) { function _lb4fa799270c_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
