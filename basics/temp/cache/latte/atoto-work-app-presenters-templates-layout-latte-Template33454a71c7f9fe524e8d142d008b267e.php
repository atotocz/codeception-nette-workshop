<?php
// source: /Users/wise/Sites/atoto-work/app/presenters/templates/@layout.latte

class Template33454a71c7f9fe524e8d142d008b267e extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('cd88decbc6', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb742721f562_head')) { function _lb742721f562_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb86f3da03ea_scripts')) { function _lb86f3da03ea_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
